...
    }
    ...
      /**
       *      * FuncA2: waits for B2, then computes A2 = B2 + sum(0..300), signals A2
       * ready.
       *      *
...
    }
    ...
      /**
       *      * Runs FuncA1, FuncA2, FuncA3 sequentially with blocking
       * synchronisation.
       *      
       */
      
...
    }
    ...
      /**
       *      * FuncB2: waits for A1, then computes B2 = A1 + sum(0..200), signals B2
       * ready.
       *      *
       *      * @throws InterruptedException if interrupted while waiting
       *      
...
    }
    ...
      /**
       *      * FuncB3: waits for A2, then computes B3 = A2 + sum(0..400), signals B3
       * ready.
       *      *
       *      * @throws InterruptedException if interrupted while waiting
       *      
...
    }
    ...
      /**
       *      * Runs FuncB1, FuncB2, FuncB3 sequentially with blocking
       * synchronisation.
       *      
       */
      
 ...
 *  * No active waiting or {@code Thread.sleep} is used; blocked threads yield
 * the
 ...
 *  * {@code notify()} to ensure all blocked threads re-evaluate their
 * condition.
 *  *
 * </p>
 *  *
...
public class projectTwo {
    ...
      
    static final long EXP_A1 = 125_250L;  /** Expected B1 = sum(0..250) = 250*251/2 = 31,375. */
      
    static final long EXP_B1 = 31_375L;  /** Expected B2 = A1 + sum(0..200) = 125250 + 20100 = 145,350. */
      
    static final long EXP_B2 = 145_350L;  /** Expected A2 = B2 + sum(0..300) = 145350 + 45150 = 190,500. */
      
    static final long EXP_A2 = 190_500L;  /** Expected B3 = A2 + sum(0..400) = 190500 + 80200 = 270,700. */
      
    static final long EXP_B3 = 270_700L;  /** Expected A3 = B3 + sum(0..400) = 270700 + 80200 = 350,900. */
      
    ...
      /**
       *      * Runs one iteration: creates a fresh {@link Monitor}, starts both
       * threads,
       ...
       *      * @throws InterruptedException if the main thread is interrupted during
       * join
       *      
       */
      
